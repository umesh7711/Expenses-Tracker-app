...
def appwindow():
    ...
    def endpage():
        ...
        Label(gui,font=("lucida fax",40),bg="#bfbfbf",text="MONEY TRACKER").place(x=190,y=10)
        ...
        Label(gui,font=("ink free",35),bg="#bfbfbf",text="Umesh Bhingare").place(x=500,y=450)
    ...
    b7=Button(gui,text="LogOut",font=("georgia",17),activebackground="#fffa66",activeforeground="red",width=10,command=endpage).place(x=700,y=650)
    b8=Button(gui,text="LogOut",font=("georgia",17),activebackground="#fffa66",activeforeground="red",width=10,command=endpage).place(x=700,y=650)
    l6=Label(gui,width=60,font=("century",35),bg="#ff9999",fg="#b32d00",text="MONEY  TRACKER").place(x=-450,y=0)
...
l6=Label(root,font=("comic sans ms",19),bg="#751aff",text="Name").place(x=853,y=195)
l3=Label(root,font=("comic sans ms",19),bg="#751aff",text="Username").place(x=804,y=243)
l4=Label(root,font=("comic sans ms",19),bg="#751aff",text="Password").place(x=810,y=293)
l5=Label(root,font=("comic sans ms",17),bg="#751aff",text="Confirm password").place(x=730,y=342)
b2=Button(root,text="Register",font=("algerian",19),activebackground="#fffa66",activeforeground="red",width=12,command=register).place(x=830,y=400)
...
e6.place(x=940,y=200,height=25,width=165)
register_username=StringVar()
e3=Entry(root,font=("adobe clean",15),textvariable=register_username)
e3.place(x=940,y=250,height=25,width=165)
register_password=StringVar()
e4=Entry(root,font=("adobe clean",15),textvariable=register_password, show="*")
e4.place(x=940,y=300,height=25,width=165)
register_repassword=StringVar()
e5=Entry(root,font=("adobe clean",15),textvariable=register_repassword, show="*")
e5.place(x=940,y=350,height=25,width=165)
Label(root,width=60,font=("jokerman",35),bg="#ff9999",fg="#cc2900",text="MONEY  TRACKER").place(x=-400,y=0)
Label(root,font=("Ink Free",27),bg="#33cccc",fg="#0000ff",text="").place(x=750,y=590)
b3=Button(root,text="Exit Window",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="red",width=10,command=root.destroy).place(x=610,y=730)
b4=Button(root,text="Delete all users",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="red",width=12,command=deleteallusers).place(x=130,y=730)
b5=Button(root,text="View all users",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="red",width=12,command=viewwindow).place(x=1030,y=730)
